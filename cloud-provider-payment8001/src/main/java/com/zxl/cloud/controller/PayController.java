...
import com.zxl.cloud.entities.PayDTO;
...
public class PayController {
    ...
    public ResultData<Pay> getByIdaaaaaaaaa(@PathVariable("id") Integer id)
    {
    ...
    private String getInfoByConsul(@Value("${zxl.info}") String zxlInfo)
    {
        return "zxlInfo: "+zxlInfo+"\t"+"port: "+port;
    }
}